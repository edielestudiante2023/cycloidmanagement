...
<body>
    ...
    <div class="container">
        <h1 class="text-center">Bienvenido al Dashboard de Consultor</h1>
        <p class="text-center">Aquí puedes consultar la información relevante de procesos y servicios.</p>
                    ...
                    <table id="gestionTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('videos-capacitaciones-back-consultor'); ?>" target="_blank" class="btn btn-primary btn-moderno px-4 py-2">
                                        Acceder al recurso
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('videos-capacitaciones-consultor'); ?>" target="_blank" class="btn btn-primary btn-moderno px-4 py-2">
                                        Acceder al recurso
                                    </a>
                                </td>
                            </tr>
